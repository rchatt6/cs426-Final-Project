...
public class bl_UIReferences : bl_PhotonHelper,IInRoomCallbacks
{
    ...
    public void ShowMenu(bool active)
    {
        ...
        if (bl_GameData.Instance.CanChangeTeam && !isOneTeamMode && ChangeTeamTimes <= bl_GameData.Instance.MaxChangeTeamTimes && !bl_RoomSettings.Instance.AutoTeamSelection)
        {
#if BDGM
